...
mod main {
    ...
    /*
     // working solution for contains duplicate from here....................
        use std::collections::HashMap;
        pub fn contains_duplicate(nums: Vec<i32>) -> bool {
            let mut num_hash = HashMap::new();
            let nums_iter = nums.iter();
            for x in nums_iter.clone() {
                let _cur_num = format!("{}", &x);
                match num_hash.get(&_cur_num) {
                    None => num_hash.insert(format!("{}", &_cur_num), 1),
                    Some(_) => {
                        println!("truuuuuuuueeeeeeee");
                        return true;
                    }
                };
            }
            println!("falssssseeeeeee");
            false
        }
     // .................................... to here.
